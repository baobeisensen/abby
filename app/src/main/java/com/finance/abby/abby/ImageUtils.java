...
public class ImageUtils {
                ...
                .setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        switch (which){
                            case 0:
                                state = 1;
                                pickImageFromCamera(activity);//打开摄像头拍照
                                break;
                            case 1:
                                state = 2;
                                pickImageFromAlbum(activity);//从相册选择照片
                                break;
                            default:
                                break;
                        }
    ...
    private static Uri getImageUri(){
        ...
        String imageName = new SimpleDateFormat("yyMMmmss").format(new java.sql.Date(new java.util.Date().getTime()).toString()) + ".jpg";
